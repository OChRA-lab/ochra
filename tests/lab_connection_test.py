...
def test_construct_object(lab_connection):
    ...
    result = lab_conn.construct_object("test_type", "test_module")
    mock_rest_adapter.construct.assert_called_once_with(
        "test_type", "test_module")
...
def test_call_on_object(lab_connection):
    ...
    result = lab_conn.call_on_object("test_id", "test_function")
...
def test_patch_object(lab_connection):
    ...
    result = lab_conn.patch_object("test_id")
    mock_rest_adapter.patch.assert_called_once_with("test_id")
