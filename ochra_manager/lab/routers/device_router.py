...
class DeviceRouter(APIRouter):
    def __init__(self):
        ...
        self.get("/{station_id}/get_by_station/{device_type}")(
            self.get_device_by_station
        )
    ...
    async def modify_device_property(
        self, object_id: str, args: ObjectPropertySetRequest
    ):
    ...
    async def get_device_by_station(self, station_id: str, device_type: str):
        return self.lab_service.get_object_by_station_and_type(
            station_id, COLLECTION, device_type
        )
